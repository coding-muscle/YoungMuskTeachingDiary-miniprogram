  ...
  methods: {
    ...
    resize: function () {
      ...
      Promise.all([
        ...
        var lineOffsetLeft = rects.slice(0, currentIndex).reduce(function (
          prev,
          curr
        ) {
    ...
    scrollIntoView: function () {
      ...
      Promise.all([
        ...
        var offsetLeft = tabRects.slice(0, currentIndex).reduce(function (
          prev,
          curr
        ) {
          return prev + curr.width;
    ...
    onBeforeChange: function (index) {
      ...
      return new Promise(function (resolve, reject) {
        _this.$emit(
          'before-change',
          __assign(__assign({}, _this.getChildData(index)), {
