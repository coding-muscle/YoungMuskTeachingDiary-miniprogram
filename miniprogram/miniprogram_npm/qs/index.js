module.exports = (function () {
  ...
  __DEFINE__(
    ...
    function (modId) {
      var map = {
        './stringify': 1738935072397,
        './parse': 1738935072400,
        './formats': 1738935072399,
      };
  ...
  __DEFINE__(
    ...
    function (modId) {
      var map = { './utils': 1738935072398, './formats': 1738935072399 };
      return __REQUIRE__(map[modId], modId);
    }
  );
  __DEFINE__(
      ...
      var encode = function encode(str, defaultEncoder, charset, kind, format) {
        ...
        for (var j = 0; j < string.length; j += limit) {
          ...
          for (var i = 0; i < segment.length; ++i) {
            ...
            i += 1;
            c =
              0x10000 + (((c & 0x3ff) << 10) | (segment.charCodeAt(i) & 0x3ff));
  ...
  __DEFINE__(
    ...
    function (modId) {
      var map = { './utils': 1738935072398 };
      return __REQUIRE__(map[modId], modId);
    }
  );
  return __REQUIRE__(1738935072396);
})();
